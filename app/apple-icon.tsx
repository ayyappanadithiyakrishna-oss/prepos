  ...
  return new ImageResponse(
    (
      <div style={{
        ...
        <svg width="140" height="140" viewBox="0 0 32 32" style={{ position: 'absolute' }}>
          {/* Wings outstretched */}
          ...
          {/* Talon details */}
          <path d="M14 25 L13 28 M16 26 L16 29 M18 25 L19 28" stroke="#a5ed6e" strokeWidth="0.8" strokeLinecap="round"/>
        </svg>
        {/* PrepOS wordmark */}
        <div style={{
          position: 'absolute',
          ...
          Prep<span style={{ color: '#58cc02' }}>OS</span>
        </div>
      </div>
    ),
    { ...size }
